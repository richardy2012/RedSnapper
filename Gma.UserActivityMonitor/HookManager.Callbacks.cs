...
namespace Gma.UserActivityMonitor
{
    public static partial class HookManager
    {
        ...
        {
            if (beforeProcessingEvent != null)
            {
                beforeProcessingEvent.Invoke(null, null);
            }
            ...
            if (nCode >= 0)
            {
                ...
                //Debug.Write(string.Format("ncode: {0} \t wParam:{1} \t lParam: {2}\n", nCode, wParam, mouseHookStruct.ExtraInfo));
