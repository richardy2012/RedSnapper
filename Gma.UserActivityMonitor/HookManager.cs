...
namespace Gma.UserActivityMonitor {
    ...
    public static partial class HookManager
    {
        ...
        private static event EventHandler beforeProcessingEvent;

        /// <summary>
        /// Occurs before this class attempts to process anything.
        /// </summary>
        public static event EventHandler BeforeProcesssing
        {
            add
            {
                //EnsureSubscribedToGlobalMouseEvents();
                beforeProcessingEvent += value;
            }
            remove
            {
                beforeProcessingEvent -= value;
